...
class PerformancePrediction:
        ...
        for user_folder in users:
            ...
            for session in sessions:
                ...
                for file in files:
                    ...
                    elif str(file).startswith('result'):
                        # print(file)
                        f_label = os.path.join(filepath, file)  # Location of the result file

                        loaded_label = self.load_file(f_label)
                        # print(loaded_label[0][0])
    ...
    def evaluate_model(self):
        ...
        n_timesteps, n_outputs = self.trainX[0].shape[1], 1
    ...
    def run_experiment(self, repeats=10):
        # load data
        self.load_dataset()
        # print(self.trainX[0].shape, self.trainY[0].shape, self.trainX[0], self.trainY[0])
        # repeat experiment
        i =0
